        ...
        <div className="knowledge-container h-full w-full pt-10">
            ...
            <div className='flex md:flex-row flex-col gap-5 items-center md:items-stretch md:justify-evenly capitalize pb-10 pt-10 px-5'>
                <div className='container-Css bg-white border border-slate-300 rounded-lg w-[20rem] shadow-2xl shadow-slate-600'>
                    ...
                    <div>
                    {CssTechnologies.map((css,index) => {return (
                      <div  key={index} className='text-center flex flex-col justify-center items-center py-5'>
                          ...
                          <p className='text-5xl text-yellow-500'>{css.fontAwesome}</p> 
                ...
                {Language.map((lang,index) => {return (
                  <div key={index} className='text-center flex flex-col justify-center items-center py-5'>
                      ...
                      <p className='text-5xl text-yellow-500'>{lang.typeScript}</p> 
                ...
                <div className='container-Css bg-white border border-slate-300 rounded-lg w-[20rem] shadow-2xl shadow-slate-600'>
                    ...
                    <p className=' text-2xl text-center p-5 font-extrabold text-slate-600 bg-white'>framework & environment</p>

                  <div>
                  {frameWork.map((frame,index) => {return (
                    <div key={index} className='text-center flex flex-col justify-center items-center py-5 '>
                        <p className='text-5xl text-gray-400'>{frame.gitHub}</p> 
                        <p className='text-xl'>{frame.gitHubText}</p> 
                        <p className='text-5xl text-red-400'>{frame.Visualstudio}</p> 
